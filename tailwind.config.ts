...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "ember-gradient":
          "linear-gradient(135deg, #fbbf24 0%, #f97316 40%, #dc2626 100%)",
        "radial-fade":
      ...
      boxShadow: {
        ...
        "glow-lg": "0 0 80px -12px rgba(249, 115, 22, 0.5)",
        "glow-red": "0 0 48px -10px rgba(220, 38, 38, 0.4)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
